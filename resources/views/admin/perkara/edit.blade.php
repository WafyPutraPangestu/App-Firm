    ...
    <div class="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-4xl font-bold text-gray-900 mb-2">Edit Perkara & Surat Kuasa</h1>
            ...
            <div class="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
                <form action="{{ route('admin.perkara.update', ['client' => $client->id, 'perkara' => $perkara->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                <input 
                                    ...
                                    name="jenis_perkara" 
                                    id="jenis_perkara"
                                    value="{{ old('jenis_perkara', $perkara->jenis_perkara) }}"
                        ...
                        <div class="group">
                            ...
                            <div class="relative">
                                <textarea 
                                    ...
                                    required
                                >{{ old('deskripsi_perkara', $perkara->deskripsi_perkara) }}</textarea>
                    ...
                    <div class="p-8 space-y-6">
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    <input 
                                        ...
                                        name="nomor_surat" 
                                        id="nomor_surat"
                                        value="{{ old('nomor_surat', $perkara->suratKuasa->nomor_surat ?? '') }}"
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    <input 
                                        ...
                                        name="tanggal_surat" 
                                        id="tanggal_surat"
                                        value="{{ old('tanggal_surat', $perkara->suratKuasa->tanggal_surat ?? date('Y-m-d')) }}"
                                        class="w-full border-2 border-gray-200 rounded-xl shadow-sm px-4 py-3 focus:border-red-800 focus:ring-4 focus:ring-red-100 transition-all duration-300 outline-none"
                                        required
                                    >
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                        ...
                        @if(isset($perkara->suratKuasa->file_path))
                        <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    <p class="text-sm font-semibold text-blue-800 mb-1">File Surat Kuasa Saat Ini</p>
                                    <p class="text-xs text-blue-600 mb-3">{{ basename($perkara->suratKuasa->file_path) }}</p>
                                    <div class="flex items-center space-x-3">
                                        <a 
                                            href="{{ asset('storage/' . $perkara->suratKuasa->file_path) }}" 
                                            target="_blank"
                        ...
                        <div class="group">
                            <label for="file_surat" class="block text-sm font-semibold text-gray-700 mb-2">
                                Upload File Surat Kuasa Baru
                                @if(!isset($perkara->suratKuasa->file_path))
                                    <span class="text-red-800">*</span>
                                @else
                                    <span class="text-gray-400 text-xs">(Opsional - kosongkan jika tidak ingin mengganti)</span>
                                @endif
                            </label>
                            <div class="relative">
                                <div class="flex items-center justify-center w-full">
                                    <label for="file_surat" class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-200 border-dashed rounded-xl cursor-pointer bg-gray-50 hover:bg-red-50 transition-all duration-300 group-focus-within:border-red-800 group-focus-within:bg-red-50">
                                        ...
                                        <input 
                                            ...
                                            class="hidden"
                                            @if(!isset($perkara->suratKuasa->file_path)) required @endif
                                        >
                                    </label>
                                </div>
                        ...
                        <div id="filePreview" class="hidden mt-4 p-4 bg-green-50 border-2 border-green-200 rounded-xl">
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="flex-1">
                                    <p class="text-sm font-semibold text-green-800">File Baru Dipilih</p>
                    ...
                    <div class="px-8 pb-8">
                        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                            <a 
                                href="{{ route('admin.clients.show', ['client' => $client->id, 'perkara' => $perkara->id]) }}" 
                            ...
                            >
                                ...
                                <span>Update Perkara & Surat Kuasa</span>
                            </button>
                        </div>
                    </div>
                </form>
