        ...
        >
            ...
            <div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="tanggal_progres"
                        class="w-full border rounded px-3 py-2"
                        required>
                </div>
            ...
            {{-- ================= DOKUMEN ================= --}}
            <div>
                <h2 class="font-semibold mb-2">Dokumen Progres</h2>
              ...
              {{-- ================= INVOICE ================= --}}
              <div>
                <h2 class="font-semibold mb-2">Invoice (Opsional)</h2>

                <div class="mb-3">
                    <label class="block">Nomor Invoice</label>
                ...
                <div class="mb-3">
                    <label class="block">Tanggal Invoice</label>
                    <input type="date" name="tanggal_invoice"
                        class="w-full border rounded px-3 py-2">
                </div>

                <div class="mb-3">
                    <label class="block">Keterangan Invoice</label>
                    <textarea name="keterangan_invoice"
                        class="w-full border rounded px-3 py-2"></textarea>
                </div>
            </div>
