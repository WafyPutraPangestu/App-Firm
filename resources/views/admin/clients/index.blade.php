    ...
    <div class="mb-6">
        <header class="mb-6">
            <div class=" px-4 sm:px-6 lg:px-8 shadow-md py-8 flex justify-between items-center bg-white ">
                ...
                <div class="">
                    <a href="{{ route('admin.clients.create') }}" class="relative px-5 py-3 bg-red-200 text-sm lg:text-base font-medium transition-all duration-300 group overflow-hidden rounded-lg">
                        <span class="relative z-10 group-hover:text-red-100 transition-colors duration-300">Create New Clients</span>
                ...
                <tbody>
                    @foreach ($user as $client)
                        <tr class="text-center px-4 py-2">
                            ...
                            <td class=" px-4 py-2">{{ $client->nik }}</td>
                            <td class=" px-4 py-2">
